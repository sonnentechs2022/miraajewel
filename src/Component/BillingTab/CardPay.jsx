...
export default function CardPay() {
  return (
    <>
 <div className="md:h-full md:-w-full bg-gray-200 flex items-center justify-center px-5 pb-10 pt-16">
    <div className="w-full mx-auto rounded-lg bg-white shadow-lg p-5 text-gray-700" >
        ...
        <div className="mb-3 flex -mx-2">
            ...
            <div className="px-2">
                <label htmlFo="type2" className="flex items-center cursor-pointer">
        ...
        <div className="mb-3">
            ...
            <div>
                <input className="w-full px-3 py-2 mb-1 border-2 border-gray-200 rounded-md focus:outline-none focus:border-indigo-500 transition-colors" placeholder="UserName" type="text"/>
            </div>
        </div>
        <div className="mb-3">
        ...
        <div className="mb-10">
            <label className="font-bold text-sm mb-2 ml-1">CVV Number</label>
            <div>
