    ...
    <>
      <div className=" w-screen lg:w-full  mt-12 ">
        <div className="flex flex-row  w-6/7 justify-start ml-20   ">
          ...
          <p className=" text-gary-500 text-sm font-Montserrat">Contact Us</p>
        </div>
        <div className="  ContactUsHead flex items-center justify-center w-full h-[100px] ">
          <div className="  text-white text-5xl font-Montserrat  ">Contact Us</div>
        </div>
        <div className="flex flex-col lg:flex-row mt-[30px] ">
          <div className="  flex flex-col  itmes-center w-full lg:w-1/4 lg:ml-10 bg-gray-100 h-[300px] lg:h-[500px]">
            <h1 className=" text-xl font-Montserrat mt-[20px]  lg:mt-[200px] ml-4 ">
              ADDRESS
            </h1>
            <p className="text-base font-Montserrat ml-4 ">
              Unit 67 Bizspace Business Park Kings Road,Tyseley,B11 2AL
            </p>

            <h1 className="text-xl font-Montserrat mt-[40px] ml-4">Contact</h1>
            <p className=" text-base  font-Montserrat ml-4">07474056956</p>

            <h1 className="text-xl  mt-[40px] mlfont-Montserrat-4">Support</h1>
            <p className="text-base  font-Montserrat ml-4">info@autumn.co.uk</p>
          </div>
          <div className=" flex flex-col  w-screen  lg:w-4/6 ml-[15px] lg:ml-[30px] mt-5">
            <h1 className=" text-black font-Montserrat text-2xl">Get In Touch</h1>
            ...
            <div className=" flex justify-center items-center  rounded-sm mt-[30px] w-[200px] h-[50px] bg-gray-900 hover:bg-gray-700">
              <p className=" text-white text-sm font-Montserrat uppercase">
                Post Comment
              </p>
